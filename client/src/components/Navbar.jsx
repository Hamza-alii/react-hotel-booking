...
const BookIcon = () => (
    <svg className="w-4 h-4 text-grey-700" aria-hidden = "true" xmlns="http://www.w3.org/200/svg" width="24" fill="none" viewBox="0 0 24 24">
        <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 19V4A1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v13H7a2 2 0 0 0-2 2zm0 oa2 2 0 0 0 2 2h12M9 3v14m7 0v4"/> 
    </svg>
)
const Navbar = () => {
    const navLinks = [
